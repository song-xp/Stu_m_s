...
<div class="row-fluid sortable">
    <div class="box span12">
		<div class="box-header" data-original-title>
			<h2><a href="${pageContext.request.contextPath}/selectAll">主页</a> / 添加学生信息</h2>
		</div>
        ...
        <hr/>
        <div class="box-content">
            <form  action="${pageContext.request.contextPath}/stuadd" method="post" onsubmit="return check()">
                <fieldset>
